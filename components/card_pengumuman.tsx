...
export default function CardPengumuman({
    ...
    return (
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 relative hover:shadow-lg transition-shadow">
        {/* Status Badge */}
        ...
        {/* Icon */}
        <div className="mb-3">
        <div className={`w-14 h-14 ${config.iconBg} rounded-xl flex items-center justify-center shadow-sm`}>
