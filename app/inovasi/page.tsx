        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="max-w-6xl mx-auto space-y-20">
                    ...
                    {/* Aplikasi E-Riset Section - Image Left, Text Right */}
                    <div className="space-y-8">
                        <h2 className="text-3xl md:text-4xl font-bold text-center text-foreground-900">
                            Aplikasi E-Riset
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                                ...
                                <Card className="overflow-hidden shadow-lg">
                                    <div className="aspect-[4/3] bg-gray-100 flex items-center justify-center">
                                        <div className="text-center p-8">
                                            ...
                                            <p className="text-base font-medium text-foreground-600">Aplikasi E-Riset</p>
                            ...
                            <div className="space-y-6">
                                <p className="text-foreground-700 leading-relaxed">
                                    Dalam penyebaran hasil penelitian ini banyak cara yang dapat dilakukan salah satunya adalah melalui sistem komunikasi yang disebut denga Elektronik Riset (e-Riset) yang memuat hasil-hasil penelitian yang telah dilakukan baik dari Perguruan Tinggi, Lembaga Penelitian, OPD dan para peneliti lainnya.
                                </p>
                                <Button
                                    color="warning"
                                    size="lg"
